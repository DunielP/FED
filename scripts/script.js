...
function openMenu() {  
  ...
  var sluitButton = document.querySelector("header nav button img:nth-of-type(4)");
...
function createFotoSlider(carrouselID) {
...
(function() {
  ...
  createFotoSlider("bolletjesAndAutoScroll");
